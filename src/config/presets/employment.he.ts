        ...
        benefits: {
          ...
          benefits: [
            ...
            },
            {
              iconName: "Wallet",
              label: "05",
              title: "תשלום רק על הצלחה",
              description:
                "בלי דמי חיפוש מראש, בלי מינוי, בלי הפתעות. משלמים רק כשהמועמד מתחיל לעבוד.",
            },
            {
              iconName: "Layers",
              label: "06",
          ...
          items: [
            {
              ...
              answer:
                "רק כשעובד שהבאנו לך מתחיל לעבוד. בלי דמי חיפוש, בלי מינוי, בלי דמי מועמדים.",
            },
            {
              question: "מה אם המועמד לא מתאים?",
              answer:
                "אם בחודש הראשון העובד לא מתאים, אנחנו מחליפים אותו ללא עלות נוספת.",
            },
            {
              question: "האם אתם מטפלים בטפסים?",
              answer:
                "כן. אנחנו מטפלים בכל ההשמה: חוזה, תיעוד, ביטוח, ותלושים — אתה מקבל חשבונית אחת.",
            },
            {
