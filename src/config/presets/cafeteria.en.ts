...
export const cafeteriaPresetEn: NichePreset = {
  ...
  staff: [
    { id: "lucas", slug: "lucas-fernandez", name: "Lucas Fernandez", specialty: "Head Barista & Founder", bio: "Former national latte art champion with 10 years in specialty coffee.", photoUrl: "", portfolio: [], schedule: { monday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, tuesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, wednesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, thursday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, friday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, saturday: { isOpen: true, hours: { start: "08:00", end: "21:00" }, breaks: [] }, sunday: { isOpen: false, hours: { start: "09:00", end: "18:00" }, breaks: [] } } },
    { id: "martina", slug: "martina-lopez", name: "Martina Lopez", specialty: "Senior Barista", bio: "Extraction and cold brew specialist with a highly trained palate.", photoUrl: "", portfolio: [], schedule: { monday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, tuesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, wednesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, thursday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, friday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, saturday: { isOpen: true, hours: { start: "08:00", end: "21:00" }, breaks: [] }, sunday: { isOpen: false, hours: { start: "09:00", end: "18:00" }, breaks: [] } } },
    { id: "santiago", slug: "santiago-ruiz", name: "Santiago Ruiz", specialty: "Roaster", bio: "A slow-fire craftsman who treats each roast profile like a piece of art.", photoUrl: "", portfolio: [], schedule: { monday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, tuesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, wednesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, thursday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, friday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, saturday: { isOpen: false, hours: { start: "08:00", end: "21:00" }, breaks: [] }, sunday: { isOpen: false, hours: { start: "09:00", end: "18:00" }, breaks: [] } } },
  ],
