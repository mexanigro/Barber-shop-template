  ...
  sections: {
    ...
    faq: {
      ...
      items: [
        ...
        {
          question: "هل الخدمة مدفوعة؟",
          answer:
            "لا! خدمتنا مجانية تماماً للباحثين عن عمل. نحن نحصل على أتعابنا من الشركات.",
        },
        {
      ...
      business: {
        ...
        benefits: {
          ...
          benefits: [
            ...
            { iconName: "Wallet", label: "05", title: "الدفع عند النجاح فقط", description: "بدون اشتراك ولا رسوم ثابتة. ادفع فقط عندما يبدأ المرشّح العمل." },
            { iconName: "Layers", label: "06", title: "هياكل مرنة", description: "دوام كامل، جزئي، مشاريع أو بدائل لإجازات مرضيّة — نطوّع الصيغة لعملك." },
          ],
        },
        workers: {
          eyebrow: "فئات نشطة",
        ...
        faq: {
          ...
          items: [
            { question: "متى أدفع؟", answer: "فقط عندما يبدأ العامل الذي أرسلناه العمل. بدون رسوم بحث أو اشتراك أو رسوم مرشّحين." },
            { question: "ماذا لو لم يناسب المرشّح؟", answer: "في الشهر الأول نستبدل أيّ عامل دون تكلفة إضافيّة." },
            { question: "هل تتولّون الأوراق؟", answer: "نعم. عقود، توثيق، تأمين، رواتب — تستلم فاتورة واحدة." },
