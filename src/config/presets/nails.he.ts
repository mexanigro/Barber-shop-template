...
export const nailsPresetHe: NichePreset = {
  ...
  sections: {
      ...
      benefits: [
        {
          ...
          desc: "כלים מעוקרים בין לקוחות; רכיבים חד־פעמיים נזרקים אחרי כל סשן; תחנות עבודה מחוטאות לסטנדרט קליני. הבטיחות והשקט נפשי במקום הראשון.",
        },
        {
          iconName: "Sparkles",
          title: "ייעוץ מותאם",
        ...
        },
        {
          ...
          desc: "בלי תבניות מוכנות ובלי תרשימים גנריים. כל עיצוב ב־Aura נולד בשבילכם — מצויר ביד ולעולם לא משוכפל.",
        },
        {
          iconName: "Award",
    ...
    faq: {
      title: "שאלות נפוצות",
      subtitle: "הכל על שירותי הציפורניים שלנו",
      items: [
        { question: "כמה זמן מחזיק סט ג׳ל?", answer: "סט ג׳ל מקצועי מחזיק בדרך כלל 3-4 שבועות עם טיפול נכון." },
        { question: "יש לכם נייל ארט?", answer: "כן! מעיצובים פשוטים ועד אמנות מצוירת ביד. ראו את הגלריה שלנו להשראה." },
        { question: "הסרת ג׳ל כלולה?", answer: "הסרת ג׳ל כלולה כשמזמינים סט חדש. הסרה בנפרד גם אפשרית." },
        { question: "מה אם ציפורן נשברת לפני התור הבא?", answer: "אנחנו מציעים תיקון חינם בשבוע הראשון לאחר התור." },
      ],
    },
  },
};
