...
export const cafeteriaPresetHe: NichePreset = {
  ...
  staff: [
    ...
    { id: "martina", slug: "martina-lopez", name: "מרטינה לופז", specialty: "בריסטה בכירה", bio: "מומחית חליטה וקולד ברו עם חיך מאומן.", photoUrl: "https://images.unsplash.com/photo-1542740348-39e5a5d22fcc?auto=format&fit=crop&q=80&w=800", portfolio: [], schedule: { monday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, tuesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, wednesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, thursday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, friday: { isOpen: true, hours: { start: "07:00", end: "15:00" }, breaks: [] }, saturday: { isOpen: false, hours: { start: "09:00", end: "18:00" }, breaks: [] }, sunday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] } } },
