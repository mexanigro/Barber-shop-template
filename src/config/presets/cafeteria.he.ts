...
export const cafeteriaPresetHe: NichePreset = {
  ...
  staff: [
    { id: "lucas", slug: "lucas-fernandez", name: "לוקאס פרננדז", specialty: "בריסטה ראשי ומייסד", bio: "אלוף לאטה ארט לאומי לשעבר עם 10 שנות ניסיון בקפה מיוחד.", photoUrl: "", portfolio: [], schedule: { monday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, tuesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, wednesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, thursday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, friday: { isOpen: true, hours: { start: "07:00", end: "15:00" }, breaks: [] }, saturday: { isOpen: false, hours: { start: "09:00", end: "18:00" }, breaks: [] }, sunday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] } } },
    { id: "martina", slug: "martina-lopez", name: "מרטינה לופז", specialty: "בריסטה בכירה", bio: "מומחית חליטה וקולד ברו עם חיך מאומן.", photoUrl: "", portfolio: [], schedule: { monday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, tuesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, wednesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, thursday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, friday: { isOpen: true, hours: { start: "07:00", end: "15:00" }, breaks: [] }, saturday: { isOpen: false, hours: { start: "09:00", end: "18:00" }, breaks: [] }, sunday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] } } },
    { id: "santiago", slug: "santiago-ruiz", name: "סנטיאגו רואיס", specialty: "קלי", bio: "אומן אש איטית שמתייחס לכל פרופיל קלייה כיצירת אמנות.", photoUrl: "", portfolio: [], schedule: { monday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, tuesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, wednesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, thursday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, friday: { isOpen: true, hours: { start: "07:00", end: "15:00" }, breaks: [] }, saturday: { isOpen: false, hours: { start: "09:00", end: "18:00" }, breaks: [] }, sunday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] } } },
  ],
  ...
  sections: {
    ...
    menu: {
      ...
      items: [
        ...
        { id: "cheesecake", name: "עוגת גבינה קרמל", subtitle: "איזון מתוק", description: "בסיס ביסקוויט, גבינת שמנת ורוטב קרמל מלוח.", category: "desserts", image: "https://images.unsplash.com/photo-1524351199432-d330df18e1cd?auto=format&fit=crop&q=80&w=600" },
      ],
    },
    faq: {
      title: "שאלות נפוצות",
