...
export const remodelacionesPresetHe: NichePreset = {
  ...
  staff: [
    { id: "lead-painter", slug: "lead-painter", name: "צבע ראשי", specialty: "מנהל פרויקטים", bio: "15+ שנות ניסיון בצביעה למגורים ומסחר.", photoUrl: "", portfolio: [], schedule: { monday: { isOpen: true, hours: { start: "07:00", end: "17:00" }, breaks: [] }, tuesday: { isOpen: true, hours: { start: "07:00", end: "17:00" }, breaks: [] }, wednesday: { isOpen: true, hours: { start: "07:00", end: "17:00" }, breaks: [] }, thursday: { isOpen: true, hours: { start: "07:00", end: "17:00" }, breaks: [] }, friday: { isOpen: true, hours: { start: "07:00", end: "14:00" }, breaks: [] }, saturday: { isOpen: false, hours: { start: "08:00", end: "13:00" }, breaks: [] }, sunday: { isOpen: true, hours: { start: "07:00", end: "17:00" }, breaks: [] } } },
  ],
