...
export const cafeteriaPresetRu: NichePreset = {
  ...
  staff: [
    { id: "lucas", slug: "lucas-fernandez", name: "Лукас Фернандес", specialty: "Главный бариста и основатель", bio: "Бывший чемпион латте-арта с 10-летним опытом в спешелти кофе.", photoUrl: "https://images.unsplash.com/photo-1577219491135-ce391730fb2c?auto=format&fit=crop&q=80&w=800", portfolio: [], schedule: { monday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, tuesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, wednesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, thursday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, friday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, saturday: { isOpen: true, hours: { start: "08:00", end: "21:00" }, breaks: [] }, sunday: { isOpen: false, hours: { start: "09:00", end: "18:00" }, breaks: [] } } },
    { id: "martina", slug: "martina-lopez", name: "Мартина Лопес", specialty: "Старший бариста", bio: "Специалист по экстракции и колд брю с высокотренированным нёбом.", photoUrl: "https://images.unsplash.com/photo-1554151228-14d9def656e4?auto=format&fit=crop&q=80&w=800", portfolio: [], schedule: { monday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, tuesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, wednesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, thursday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, friday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, saturday: { isOpen: true, hours: { start: "08:00", end: "21:00" }, breaks: [] }, sunday: { isOpen: false, hours: { start: "09:00", end: "18:00" }, breaks: [] } } },
    { id: "santiago", slug: "santiago-ruiz", name: "Сантьяго Руис", specialty: "Обжарщик", bio: "Мастер медленного огня, относящийся к каждому профилю обжарки как к произведению искусства.", photoUrl: "https://images.unsplash.com/photo-1600565193348-f74bd3c7ccdf?auto=format&fit=crop&q=80&w=800", portfolio: [], schedule: { monday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, tuesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, wednesday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, thursday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, friday: { isOpen: true, hours: { start: "07:00", end: "20:00" }, breaks: [] }, saturday: { isOpen: false, hours: { start: "08:00", end: "21:00" }, breaks: [] }, sunday: { isOpen: false, hours: { start: "09:00", end: "18:00" }, breaks: [] } } },
  ],
