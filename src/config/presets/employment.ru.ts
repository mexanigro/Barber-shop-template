      ...
      business: {
        ...
        benefits: {
          ...
          benefits: [
            ...
            { iconName: "Wallet", label: "05", title: "Оплата только за результат", description: "Без аванса, без подписки, без скрытых платежей. Вы платите, когда кандидат вышел на работу." },
            { iconName: "Layers", label: "06", title: "Гибкий формат", description: "Полная занятость, частичная, проектная или замена на больничный — подстраиваемся под ваш бизнес." },
          ],
        },
        workers: {
        ...
        faq: {
          ...
          items: [
            { question: "Когда я плачу?", answer: "Только когда работник, которого мы привели, вышел на работу. Никаких поисковых, абонентских или кандидатских платежей." },
            { question: "Что, если кандидат не подойдёт?", answer: "В первый месяц мы бесплатно меняем работника, если он не подошёл." },
            { question: "Вы оформляете документы?", answer: "Да. Договоры, документация, страховка, расчёты — вы получаете один счёт." },
