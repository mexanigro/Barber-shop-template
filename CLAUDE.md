...
npm test               # las 16 suites (lista en package.json: 8 + contrato-hooks + diseno-reglas + palette + gama + material + hero-viewport + modo-paleta + hero-mask) — referencia en main: todos exit 0, fail 0
