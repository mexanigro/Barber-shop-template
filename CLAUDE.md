...
npm test               # las 14 suites (lista en package.json: 8 + contrato-hooks + diseno-reglas + palette + gama + material + hero-viewport) — referencia en main: todos exit 0, fail 0
